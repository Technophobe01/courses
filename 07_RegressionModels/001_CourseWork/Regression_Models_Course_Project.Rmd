...
This document develops and answers the [John Hopkins - Coursera Regression Models - Course Project][0]. The goal of the report is to illustrate via simulation and associated explanatory text the properties of the [mtcars][1] dataset. The dataset is derived from the *[Henderson and Velleman (1981), Building multiple regression models interactively. Biometrics, 37, 391–411. ][3]* study. Our task is to explore the relationship between a set of variables and miles per gallon (MPG). _**Our primary goal is to ask and answer the following questions in the context of working for Motor Trend, a magazine about the automobile industry**_. 
...
This report was requested to enable a review of the 1974 magazine data on past car mpg performance and changes in vehicle efficiency. Based upon our analysis we conclude that in 1974: 
...
[2]: https://github.com/Technophobe01/courses/tree/master/07_RegressionModels/001_Course_Work
