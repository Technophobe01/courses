...
requiredPackages <- c("devtools","dplyr","tidyr","data.table","ggplot2","ggvis","RMySQL", "jsonlite", "psych", "knitr")
...
# 
# 
gp <- ggplot(data.frame(geo.cluster$centers), aes(longitude, latitude, color = cities))
