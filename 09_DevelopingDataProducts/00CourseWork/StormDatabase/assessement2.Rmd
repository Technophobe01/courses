...
```{r writeOutData, echo=FALSE, results='hide' }
...
dataDir         <- "./data"
fileName        <- "cleanStormData.csv"         # File to create
filePath        <- file.path(dataDir, fileName) # Filepath to file
...
write.csv(cleanStormData, file = filePath) 
bzip2(filePath, overwrite = TRUE, remove = TRUE)
```
...
```{r PopulationDamage, fig.width=10, fig.height=8}
